...
|---|---|---|---|---|---|---|---|---|---|
| `mochidock-pm` | Personal | `mochidock-pm` | Local | `mochidock-pm` | `~/.agents/skills/mochidock-pm` | Maintain in this repository | Yes | MochiDock stage, scope, risk, handoff, and takeover management | Project-specific; does not replace implementation Skills or user product decisions. |
